...
export class ConfigSystem {
    ...
    constructor(config: any) {
        ...
        this.name = new Array(EntityIndex).fill(0);
    ...
    public setupItems() {
        ...
        this.name[ItemType.HAND]                     = 'HAND';
        this.name[ItemType.MACHETE]                  = 'MACHETE';
 
        this.name[ItemType.WOOD_SWORD]               = 'WOOD_SWORD';
        this.name[ItemType.STONE_SWORD]              = 'STONE_SWORD';
        this.name[ItemType.GOLD_SWORD]               = 'GOLD_SWORD';
        this.name[ItemType.DIAMOND_SWORD]            = 'DIAMOND_SWORD';
        this.name[ItemType.PIRATE_SWORD]             = 'PIRATE_SWORD';
        this.name[ItemType.AMETHYST_SWORD]           = 'AMETHYST_SWORD';
        this.name[ItemType.REIDITE_SWORD]            = 'REIDITE_SWORD';
        this.name[ItemType.DRAGON_SWORD]             = 'DRAGON_SWORD';
        this.name[ItemType.LAVA_SWORD]               = 'LAVA_SWORD';
 
        this.name[ItemType.WOOD_SPEAR]               = 'WOOD_SPEAR';
        this.name[ItemType.CRAB_SPEAR]               = 'CRAB_SPEAR';
        this.name[ItemType.STONE_SPEAR]              = 'STONE_SPEAR';
        this.name[ItemType.GOLD_SPEAR]               = 'GOLD_SPEAR';
        this.name[ItemType.DIAMOND_SPEAR]            = 'DIAMOND_SPEAR';
        this.name[ItemType.AMETHYST_SPEAR]           = 'AMETHYST_SPEAR';
        this.name[ItemType.REIDITE_SPEAR]            = 'REIDITE_SPEAR';
        this.name[ItemType.DRAGON_SPEAR]             = 'DRAGON_SPEAR';
        this.name[ItemType.LAVA_SPEAR]               = 'LAVA_SPEAR';
 
        this.name[ItemType.WOOD_PICK]                = 'WOOD_PICK';
        this.name[ItemType.STONE_PICK]               = 'STONE_PICK';
        this.name[ItemType.GOLD_PICK]                = 'GOLD_PICK';
        this.name[ItemType.DIAMOND_PICK]             = 'DIAMOND_PICK';
        this.name[ItemType.AMETHYST_PICK]            = 'AMETHYST_PICK';
        this.name[ItemType.REIDITE_PICK]             = 'REIDITE_PICK';

        this.name[ItemType.WOOD_SHIELD]              = 'WOOD_SHIELD';
        this.name[ItemType.STONE_SHIELD]             = 'STONE_SHIELD';
        this.name[ItemType.GOLD_SHIELD]              = 'GOLD_SHIELD';
        this.name[ItemType.DIAMOND_SHIELD]           = 'DIAMOND_SHIELD';
        this.name[ItemType.AMETHYST_SHIELD]          = 'AMETHYST_SHIELD';
        this.name[ItemType.REIDITE_SHIELD]           = 'REIDITE_SHIELD';
 
        this.name[ItemType.STONE_HAMMER]             = 'STONE_HAMMER';
        this.name[ItemType.GOLD_HAMMER]              = 'GOLD_HAMMER';
        this.name[ItemType.DIAMOND_HAMMER]           = 'DIAMOND_HAMMER';
        this.name[ItemType.AMETHYST_HAMMER]          = 'AMETHYST_HAMMER';
        this.name[ItemType.REIDITE_HAMMER]           = 'REIDITE_HAMMER';
        this.name[ItemType.SUPER_HAMMER]             = 'SUPER_HAMMER';
        ...
        this.itemRadius[ItemType.WATERING_CAN]       = 45;
        ...
        this.itemOffset[ItemType.WATERING_CAN]       = 50;
        ...
        this.itemFoodValue[ItemType.FOODFISH]                  = 18;
        ...
        this.itemFoodValue[ItemType.FOODFISH_COOKED]           = 35;
    ...
    public setupSeeds() {
        ...
        this.seedFruits[EntityType.WHEAT_SEED] = ItemType.WHEAT_SEED;
