...
RECIPES[ItemType.EXTRACTOR_MACHINE_STONE] = {
    r: [
        [ItemType.WOOD, 50],
        [ItemType.STONE, 100]
    ],
...
RECIPES[ItemType.EXTRACTOR_MACHINE_GOLD] = {
    r: [
        [ItemType.STONE, 60],
        [ItemType.GOLD, 120]
    ],
...
RECIPES[ItemType.EXTRACTOR_MACHINE_DIAMOND] = {
    r: [
        [ItemType.GOLD, 70],
...
RECIPES[ItemType.EXTRACTOR_MACHINE_AMETHYST] = {
    r: [
        [ItemType.DIAMOND, 80],
        [ItemType.AMETHYST, 160]
    ],
...
RECIPES[ItemType.EXTRACTOR_MACHINE_REIDITE] = {
    r: [
...
RECIPES[ItemType.FUR_HAT] = {
    r: [
        ...
        [ItemType.FUR_WINTER, 5],
        [ItemType.FUR_MAMMOTH, 10],
        [ItemType.BLUE_CORD, 4]
    ],
    f: 0,
    e: 0,
...
RECIPES[ItemType.WINTER_HOOD] = {
    r: [
        [ItemType.HOOD, 1],
        [ItemType.SPECIAL_FUR_2, 1],
        [ItemType.FUR_WINTER, 15],
        [ItemType.BLUE_CORD, 5],
        [ItemType.PENGUIN_FEATHER, 8]
    ],
    f: 0,
...
RECIPES[ItemType.WINTER_PEASANT] = {
    r: [
        [ItemType.PEASANT, 1],
        [ItemType.SPECIAL_FUR, 1],
        [ItemType.FUR_WINTER, 10],
        [ItemType.BLUE_CORD, 5],
        [ItemType.PENGUIN_FEATHER, 8]
    ],
    f: 0,
...
RECIPES[ItemType.FOODFISH_COOKED] = {
    r: [
        [ItemType.FOODFISH, 1]
    ],
    f: 1,
